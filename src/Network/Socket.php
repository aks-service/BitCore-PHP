...
use Bit\Validation\Validation;
use Exception;
use InvalidArgumentException;

/**
 * BitPHP network socket connection class.
 *
...
class Socket
{
    ...
    /**
     * True if the socket stream is encrypted after a Bit\Network\Socket::enableCrypto() call
     *
     * @var bool
     */
     ...
     * @see \Bit\Network\Socket::$_baseConfig
     */
     ...
     *
     * @return bool Success
     * @throws \Bit\Network\Exception\SocketException
     */
     ...
     * @throws \Bit\Network\Exception\SocketException When attempting to enable SSL/TLS fails
