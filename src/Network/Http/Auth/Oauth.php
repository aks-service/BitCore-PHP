...
/**
 * Oauth 1 authentication strategy for Bit\Network\Http\Client
 *
...
class Oauth
{
     ...
     * @return void
     * @throws \Bit\Core\Exception\Exception On invalid signature types.
     */
     ...
     * @throws \Bit\Core\Exception\Exception On invalid URLs
     */
