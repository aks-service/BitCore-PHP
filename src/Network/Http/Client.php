 ...
 * an empty instance of Bit\Network\Http\CookieCollection will be created.
 *
 ...
 * BitPHP comes with a few built-in strategies:
 *
 * - Basic
 * - Digest
 * - Oauth
 ...
 * BitPHP comes with built-in support for basic authentication.
 *
 */
class Client
{
    ...
    protected $_defaultConfig = [
        'adapter' => 'Bit\Network\Http\Adapter\Stream',
        'host' => null,
        'port' => null,
        'scheme' => 'http',
        'timeout' => 30,
     ...
     * request host name.
     *
     * @var \Bit\Network\Http\CookieCollection
     */
    protected $_cookies;

    /**
     * Adapter for sending requests. Defaults to
     * Bit\Network\Http\Adapter\Stream
     *
     * @var \Bit\Network\Http\Adapter\Stream
     */
    protected $_adapter;
     ...
     *
     * @return \Bit\Network\Http\CookieCollection
     */
     ...
     * @return \Bit\Network\Http\Response
     */
     ...
     *
     * @param \Bit\Network\Http\Request $request The request to send.
     ...
     * @param mixed $data The request body.
     * @param array $options The options to use. Contains auth, proxy etc.
     * @return \Bit\Network\Http\Request
     */
     ...
     * @throws \Bit\Core\Exception\Exception When an unknown type alias is used.
     */
     ...
     *
     * @param \Bit\Network\Http\Request $request The request to modify.
     ...
     * @throws \Bit\Core\Exception\Exception when an invalid strategy is chosen.
     */
    protected function _createAuth($auth, $options)
    {
        ...
        $class = Bit::className($name, 'Network/Http/Auth');
        if (!$class) {
            throw new Exception(
