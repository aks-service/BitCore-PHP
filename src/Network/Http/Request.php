 ...
 *
 * Used by Bit\Network\Http\Client to contain request information
 * for making requests.
 */
class Request extends Message
{
     ...
     * @throws \Bit\Core\Exception\Exception On invalid methods.
     */
     ...
     *
     * ```
     * $request->header(['Connection' => 'close', 'User-Agent' => 'BitPHP']);
     * ```
     *
