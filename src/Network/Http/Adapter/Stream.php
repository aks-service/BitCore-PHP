...
namespace Bit\Network\Http\Adapter;

use Bit\Core\Exception\Exception;
use Bit\Network\Http\FormData;
use Bit\Network\Http\Request;
use Bit\Network\Http\Response;

/**
 * Implements sending Bit\Network\Http\Request
...
class Stream
{
     ...
     *
     * @param \Bit\Network\Http\Request $request The request object to send.
     ...
     *
     * @param \Bit\Network\Http\Request $request The request to build context from.
     ...
     *
     * @param \Bit\Network\Http\Request $request The request being sent.
     ...
     * Array data will be processed with Bit\Network\Http\FormData
     *
     * @param \Bit\Network\Http\Request $request The request being sent.
     * @param array $options Array of options to use.
     * @return void
