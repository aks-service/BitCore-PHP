<?php
namespace Bit\Network;

use ArrayAccess;
use BadMethodCallException;
use Bit\Core\Configure;
use Bit\Network\Exception\MethodNotAllowedException;
...
class Request implements ArrayAccess
{
     ...
     *
     * There are several ways to specify a detector, see Bit\Network\Request::addDetector() for the
     ...
     * @return string URI The BitPHP request path that is being accessed.
     */
     ...
     *
     * If BitPHP is called with index.php in the URL even though
     ...
     *
     * @param \Bit\Network\Session|null $session the session object to use
     * @return \Bit\Network\Session
     */
     ...
     * defined with Bit\Network\BitRequest::addDetector(). Any detector can be called
     ...
     * by BitPHP internally, and will effect the result of this method.
     *
     ...
     *
     * Generally you want to use Bit\Network\Request::accept() to get a simple list
     ...
     *
     * ``` \Bit\Network\Request::acceptLanguage(); ```
     *
     * Check if a specific language is accepted:
     *
     * ``` \Bit\Network\Request::acceptLanguage('es-es'); ```
     *
     ...
     * to use a syntax similar to `BitSession` for reading URL query data.
     *
     ...
     * to use a syntax similar to `Bit\Model\Datasource\Session` for reading post data.
     *
     * ### Reading values.
     *
     * ```
     ...
     * @return bool true
     * @throws \Bit\Network\Exception\MethodNotAllowedException
     */
