...
use Bit\Network\Exception\NotFoundException;
...
/**
 * Bit Response is responsible for managing the response text, status and headers of a HTTP response.
 *
...
class Response
{
    ...
    /**
     * Sets the cookies that have been added via Bit\Network\Response::cookie() before any
     ...
     * ### Full URI
     * ```
     * cors($request, 'http://www.bitcoding.org');
     * ```
     *
     * ### URI with wildcard
     * ```
     * cors($request, 'http://*.bitcoding.org');
     * ```
     *
     * ### Ignoring the requested protocol
     * ```
     * cors($request, 'www.bitcoding.org');
     * ```
     *
     * ### Any URI
     * ```
     ...
     * ### Whitelist of URIs
     * ```
     * cors($request, ['http://www.bitcoding.org', '*.google.com', 'https://myproject.github.io']);
     * ```
     *
     ...
     * @return \Bit\Network\CorsBuilder A builder object the provides a fluent interface for defining
     ...
     * @return void
     * @throws \Bit\Network\Exception\NotFoundException
     */
    public function file($path, array $options = [])
    {
        ...
        if (!$file->exists() || !$file->readable()) {
            ...
            throw new NotFoundException(__d('bit', 'The requested file was not found'));
        }
     ...
     *
     * @return \Bit\Filesystem\File|null The file to use in the response or null
     */
     ...
     * in the response.
     *
     * @param \Bit\Filesystem\File $file The file to set a range on.
     ...
     *
     * @param \Bit\Filesystem\File $file File object
