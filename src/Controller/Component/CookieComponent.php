 ...
 * In addition to the basic features offered be Bit\Network\Response, this class lets you:
 *
...
class CookieComponent extends Component
{
     ...
     *   under a subfolder "bitapp" of document root the path would be "/bitapp/"
     *   else it would be "/".
    ...
    /**
     * A reference to the Controller's Bit\Network\Response object
     *
