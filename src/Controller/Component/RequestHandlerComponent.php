...
use Bit\Controller\ComponentRegistry;
...
use Bit\Utility\Exception\XmlException;
 ...
 * and the like. These units have no use for AJAX requests, and this Component can tell how Bit
...
class RequestHandlerComponent extends Component
{
     ...
     *
     * @var string
     * @see \Bit\Routing\Router::extensions()
     */
    public $ext = null;
     ...
     *
     * @param \Bit\Controller\ComponentRegistry $registry ComponentRegistry object.
     ...
     * been configured in {@link Bit\Routing\Router}.
     *
     ...
     * @param \Bit\Network\Response $response The response instance.
     * @return void
     */
     ...
     *
     * @param \Bit\Event\Event $event The startup event that was fired.
     * @return void
     */
     ...
     *
     * @param \Bit\Event\Event $event The Controller.beforeRedirect event.
     * @param string|array $url A string or array containing the redirect location
     * @param \Bit\Network\Response $response The response object.
     * @return \Bit\Network\Response|null The response object if the redirect is caught.
     */
     ...
     *   types will only switch to mime-types recognized by Bit\Network\Response.
     *   If you need to declare additional mime-types, you can do so using
     *   Bit\Network\Response::type() in your controller's beforeFilter() method.
     ...
     *
     * @param \Bit\Event\Event $event The Controller.beforeRender event.
     ...
     * header. Unlike Bit\Network\Request::accepts() this method deals entirely with mapped content types.
     *
     * Usage:
     *
     * ```
     ...
     * ```
     *
     * @param \Bit\Controller\Controller $controller A reference to a controller object
     * @param string $type Type of response to send (e.g: 'ajax')
     * @param array $options Array of options to use
     * @return void
     * @see \Bit\Controller\Component\RequestHandlerComponent::respondAs()
     */
    public function renderAs(Controller $controller, $type, array $options = [])
    {
        ...
        if ($builder->className() === null) {
            $viewClass = Bit::className($view, 'View', 'View');
        }
        ...
        if (!in_array($helper, $controller->helpers) && empty($controller->helpers[$helper])) {
            $helperClass = Bit::className($helper, 'View/Helper', 'Helper');
     ...
     * available on Bit\Network\Response. It also allows you to use Content-Type aliases.
     *
