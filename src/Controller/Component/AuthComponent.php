...
use Bit\Auth\Storage\StorageInterface;
...
use Bit\Network\Exception\ForbiddenException;
...
class AuthComponent extends Component
{
     ...
     * Storage object.
     *
     * @var \Bit\Auth\Storage\StorageInterface
     */
    protected $_storage;
     ...
     *
     * @var array
     * @see \Bit\Controller\Component\AuthComponent::allow()
     */
     ...
     *
     * @param \Bit\Controller\Controller $controller A reference to the instantiating
     *   controller object
     ...
     * is returned.
     *
     * @param \Bit\Controller\Controller $controller A reference to the controller object.
     * @return \Bit\Network\Response|null Null if current action is login action
     ...
     * @throws \Bit\Network\Exception\ForbiddenException
     */
    ...
    protected function _setDefaults()
    {
        $defaults = [
            ...
            'authError' => __d('bit', 'You are not authorized to access that location.')
        ];
     ...
     * @param \Bit\Network\Request|null $request The request to authenticate for.
    ...
    public function constructAuthorize()
    {
        ...
        foreach ($authorize as $alias => $config) {
            ...
            $className = Bit::className($class, 'Auth', 'Authorize');
     ...
     * @return \Bit\Auth\BaseAuthorize|null
     */
    ...
    public function constructAuthenticate()
    {
        ...
        foreach ($authenticate as $alias => $config) {
            ...
            $className = Bit::className($class, 'Auth', 'Authenticate');
            if (!class_exists($className)) {
     ...
     *
     * @param \Bit\Auth\Storage\StorageInterface|null $storage Sets provided
     *   object as storage or if null returns configured storage object.
     * @return \Bit\Auth\Storage\StorageInterface|null
     */
    public function storage(StorageInterface $storage = null)
    {
        ...
        $className = Bit::className($class, 'Auth/Storage', 'Storage');
        if (!class_exists($className)) {
     ...
     *
     * @return \Bit\Auth\BaseAuthenticate|null
     */
