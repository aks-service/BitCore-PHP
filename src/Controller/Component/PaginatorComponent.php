...
use Bit\Datasource\QueryInterface;
use Bit\Datasource\RepositoryInterface;
...
class PaginatorComponent extends Component
{
     ...
     *
     * By default BitPHP will automatically allow sorting on any column on the table object being
     ...
     *   return $q->where(['name' => 'BitPHP'])
     * });
     * $results = $paginator->paginate($query);
     * ```
     *
     * @param \Bit\Datasource\RepositoryInterface|\Bit\Datasource\QueryInterface $object The table or query to paginate.
     * @param array $settings The settings/configuration used for pagination.
     * @return \Bit\Datasource\ResultSetInterface Query results
     ...
     *
     * @param \Bit\Datasource\RepositoryInterface $object Repository object.
