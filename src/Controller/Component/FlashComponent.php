...
use Bit\Network\Exception\InternalErrorException;
use Bit\Utility\Inflector;
use Exception;

/**
 * The BitPHP FlashComponent provides a way for you to write a flash variable
...
class FlashComponent extends Component
{
     ...
     * Constructor
     *
     * @param \Bit\Controller\ComponentRegistry $registry A ComponentRegistry for this component
     ...
     * @return void
     * @throws \Bit\Network\Exception\InternalErrorException If missing the flash message.
     */
