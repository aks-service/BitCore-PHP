 ...
 *
 * @see \Bit\Controller\Controller::$components
 */
class Component implements EventListenerInterface
{
     ...
     * Constructor
     *
     * @param \Bit\Controller\ComponentRegistry $registry A ComponentRegistry this component can use to lazy load its components
