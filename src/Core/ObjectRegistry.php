 ...
 * as a super class for various composition based re-use features in BitPHP.
 *
 ...
 * \Bit\Event\EventDispatcherTrait to attach and detach on set and bind
 *
 * @see \Bit\Controller\ComponentRegistry
 * @see \Bit\View\HelperRegistry
 * @see \Bit\Console\TaskRegistry
 */
abstract class ObjectRegistry
{
     ...
     *
     * Using Bit\Controller\Controller::$components as an example. You can alias
