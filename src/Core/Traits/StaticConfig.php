...
trait StaticConfig
{
     ...
     *
     * $dsn = 'Bit\Log\Engine\FileLog://?types=notice,info,debug&file=debug&path=LOGS';
     ...
     *
     * $dsn = 'File://?prefix=myapp_bit_core_&serialize=true&duration=+2 minutes&path=/tmp/persistent/';
     * $config = Cache::parseDsn($dsn);
     * ```
     *
