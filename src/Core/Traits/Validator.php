...
trait Validator
{
     ...
     * @var string
     */
    protected $_validatorClass = '\Bit\Validation\Validator';
     ...
     *
     * ```
     * $validator = new \Bit\Validation\Validator($table);
     * $validator
     *  ->add('email', 'valid-email', ['rule' => 'email'])
     *  ->add('password', 'valid', ['rule' => 'notBlank'])
     *  ->allowEmpty('bio');
     ...
     * @param \Bit\Validation\Validator|null $validator The validator instance to store,
     *   use null to get a validator.
     * @return \Bit\Validation\Validator
     */
     ...
     *
     * @param \Bit\Validation\Validator $validator The validator that can be modified to
