 ...
 * ```
 *
 * @see \Bit\Core\Configure::load() for how to load custom configuration files.
 */
class PhpConfig implements ConfigEngineInterface
{
     ...
     * @throws \Bit\Core\Exception\Exception when files don't exist or they don't contain `$config`.
