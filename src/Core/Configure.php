...
use Bit\Core\Configure\Engine\PhpConfig;
...
class Configure
{
     ...
     * out of configure into the various other classes in BitPHP.
     *
     ...
     * files in various formats/storage locations. BitPHP comes with two built-in engines
     ...
     * @param \Bit\Core\Configure\ConfigEngineInterface $engine The engine to append.
     * @return void
     */
     ...
     * @return bool Success
     * @throws \Bit\Core\Exception\Exception if the adapter does not implement a `dump` method.
     */
     ...
     * @return \Bit\Core\Configure\ConfigEngineInterface|false Engine instance or false
     */
    ...
    /**
     * Used to determine the current version of BitPHP.
     *
     * Usage
     * ```
     * Configure::version();
     * ```
     *
     * @return string Current version of BitPHP
     */
    public static function version()
    {
        if (!isset(static::$_values['Bit']['version'])) {
            $config = require CORE_PATH . 'config/config.php';
            static::write($config);
        }
        return static::$_values['Bit']['version'];
    }
