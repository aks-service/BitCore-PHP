...
class RouteCollection
{
     ...
     *
     * @param \Bit\Routing\Route\Route $route The route object to add.
     ...
     * @throws \Bit\Routing\Exception\MissingRouteException When a URL has no matching route.
     */
     ...
     * @throws \Bit\Routing\Exception\MissingRouteException when a route cannot be matched.
     */
