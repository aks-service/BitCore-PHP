...
class DispatcherFilter implements EventListenerInterface
{
     ...
     *
     * @param \Bit\Event\Event $event The event to match.
     * @return bool
     */
     ...
     *
     * If a Bit\Network\Response object instance is returned, it will be served at the end of the
     ...
     *
     * @param \Bit\Event\Event $event container object having the `request`, `response` and `additionalParams`
     ...
     * Alternatively you can call `$event->stopPropagation()` to achieve the same result.
     *
     * @param \Bit\Event\Event $event container object having the `request` and  `response`
     *    keys in the data property.
     * @return void
     */
