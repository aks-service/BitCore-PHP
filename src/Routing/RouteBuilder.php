...
class RouteBuilder
{
     ...
     * @var string
     */
    protected $_routeClass = 'Bit\Routing\Route\Route';
     ...
     *
     * @param \Bit\Routing\RouteCollection $collection The route collection to append routes into.
     ...
     *
     * @param string|\Bit\Routing\Route\Route $route The route template or route object.
     * @param array $defaults Default parameters.
     * @param array $options Additional options parameters.
     * @return \Bit\Routing\Route\Route
    ...
    {
        if (is_string($route)) {
            $routeClass = Bit::className($options['routeClass'], 'Routing/Route');
            if ($routeClass === false) {
        ...
        throw new InvalidArgumentException(
            'Route class not found, or route class is not a subclass of Bit\Routing\Route\Route'
        );
    }
