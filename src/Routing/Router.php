...
class Router
{
     ...
     * @var bool
     */
    protected static $_defaultRouteClass = 'Bit\Routing\Route\Route';
     ...
     *
     * @var \Bit\Routing\RouteCollection
     */
     ...
     * @see \Bit\Routing\Router::$_namedExpressions
     */
     ...
     *
     * Compatibility proxy to \Bit\Routing\RouteBuilder::connect() in the `/` scope.
     *
     ...
     * @see \Bit\Routing\RouteBuilder::connect()
     * @see \Bit\Routing\Router::scope()
     */
     ...
     *
     * Compatibility proxy to \Bit\Routing\RouteBuilder::redirect() in the `/` scope.
     *
     * @param string $route A string describing the template of the route
     * @param array $url An URL to redirect to. Can be a string or a Bit array-based URL
     * @param array $options An array matching the named elements in the route to regular expressions which that
     *   element should match. Also contains additional parameters such as which routed parameters should be
     *   shifted into the passed arguments. As well as supplying patterns for routing parameters.
     * @return void
     * @see \Bit\Routing\RouteBuilder::redirect()
     */
    public static function redirect($route, $url, $options = [])
    {
        $options['routeClass'] = 'Bit\Routing\Route\RedirectRoute';
        if (is_string($url)) {
            $url = ['redirect' => $url];
        }
     ...
     *
     * Compatibility proxy to \Bit\Routing\RouteBuilder::resources(). Additional, compatibility
     ...
     * @see \Bit\Routing\RouteBuilder::resources()
     * @return void
     */
     ...
     * @throws \Bit\Routing\Exception\MissingRouteException When a route cannot be handled
     */
     ...
     *
     * Will accept either a Bit\Network\Request object or an array of arrays. Support for
     * accepting arrays may be removed in the future.
     *
     * @param \Bit\Network\Request|array $request Parameters and path information or a Bit\Network\Request object.
     * @return void
     */
     ...
     *
     * @param \Bit\Network\Request $request The request instance.
     * @return void
     */
     ...
     *
     * @return \Bit\Network\Request The request removed from the stack.
     * @see \Bit\Routing\Router::pushRequest()
     * @see \Bit\Routing\RequestActionTrait::requestAction()
     */
     ...
     * @return \Bit\Network\Request|null
     */
     ...
     * @see \Bit\Routing\Router::url()
     * @see \Bit\Routing\Router::addUrlFilter()
     */
     ...
     *   is not in the root directory, this can be used to generate URLs that are 'bit relative'.
     *   bit relative URLs are required when using requestAction.
     ...
     * @throws \Bit\Core\Exception\Exception When the route name is not found
     */
     ...
     * are used for BitPHP internals and should not normally be part of an output URL.
     *
     * @param \Bit\Network\Request|array $params The params array or
     *     Bit\Network\Request object that needs to be reversed.
     ...
     *
     * @param \Bit\Network\Request $request The request object to modify.
     * @param array $options The array of options.
     * @return \Bit\Network\Request The modified request
     */
