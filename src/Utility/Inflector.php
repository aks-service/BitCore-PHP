 ...
 * Used by BitPHP's naming conventions throughout the framework.
 *
 */
class Inflector
{
    ...
    /**
     * Returns Bit model class name ("Person" for the database table "people".) for given database table.
     *
