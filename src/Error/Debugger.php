...
class Debugger
{
    ...
    protected $_templates = [
        ...
        'html' => [
            'trace' => '<pre class="biterror trace"><b>Trace</b> <p>{:trace}</p></pre>',
            'context' => '<pre class="biterror context"><b>Context</b> <p>{:context}</p></pre>',
            'escapeContext' => true,
        ],
        'txt' => [
    ...
    public function __construct()
    {
        ...
        $e .= '<div id="{:id}-trace" class="bitstack-trace" style="display: none;">';
        $e .= '{:links}{:info}</div>';
        $e .= '</pre>';
        $this->_templates['js']['error'] = $e;

        $t = '<div id="{:id}-trace" class="bitstack-trace" style="display: none;">';
        ...
        $this->_templates['js']['context'] = '<pre id="{:id}-context" class="bitcontext" ';
        $this->_templates['js']['context'] .= 'style="display: none;">{:context}</pre>';

        $this->_templates['js']['code'] = '<pre id="{:id}-code" class="bitcode-dump" ';
        $this->_templates['js']['code'] .= 'style="display: none;">{:code}</pre>';

        $e = '<pre class="biterror"><b>{:error}</b> ({:code}) : {:description} ';
        $e .= '[<b>{:path}</b>, line <b>{:line}]</b></pre>';
        $this->_templates['html']['error'] = $e;

        $this->_templates['html']['context'] = '<pre class="bitcontext"><b>Context</b> ';
     ...
     * @return void
     * @see \Bit\Error\Debugger::exportVar()
     */
    ...
    /**
     * Shortens file paths by replacing the application base path with 'APP', and the BitPHP core
     * path with 'CORE'.
     *
    ...
    {
        if (!defined('BIT_CORE_INCLUDE_PATH') || !defined('APP')) {
            return $path;
        }
        ...
        if (strpos($path, BIT_CORE_INCLUDE_PATH) === 0) {
            return str_replace(BIT_CORE_INCLUDE_PATH, 'CORE', $path);
        }
     ...
     * shown in an error message if BitPHP is deployed in development mode.
     *
