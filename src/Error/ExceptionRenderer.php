...
use Bit\Core\Exception\MissingPluginException;
use Bit\Event\Event;
use Bit\Network\Exception\HttpException;
 ...
 * When debug is false a BitException will render 404 or 500 errors. If an uncaught exception is thrown
...
class ExceptionRenderer
{
    ...
    /**
     * Template to render for Bit\Core\Exception\Exception
     *
     * @var string
     */
    public $template = '';
     ...
     * If the error is a Bit\Core\Exception\Exception it will be converted to either a 400 or a 500
     ...
     *
     * @return \Bit\Controller\Controller
    ...
    protected function _getController()
    {
        ...
        try {
            $class = Bit::className('Error', 'Controller', 'Controller');
     ...
     *
     * @return \Bit\Network\Response The response to be sent.
     */
     ...
     * @return \Bit\Network\Response The response to send.
     */
    ...
    protected function _message(Exception $exception, $code)
    {
        ...
        if (!Configure::read('debug') &&
            ...
            if ($code < 500) {
                $message = __d('bit', 'Not Found');
            } else {
                $message = __d('bit', 'An Internal Error Has Occurred.');
            }
        }
     ...
     * @return \Bit\Network\Response A response object that can be sent.
     */
     ...
     *
     * @return \Bit\Network\Response The response to serve.
     */
