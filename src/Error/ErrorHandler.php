 ...
 * ### Uncaught exceptions
 *
 * When debug < 1 a BitException will render 404 or 500 errors. If an uncaught exception is thrown
 ...
 * `Bit\Error\ExceptionRenderer` is used. Your custom exception renderer class should be placed in src/Error.
 *
 ...
 *
 * @see \Bit\Error\ExceptionRenderer for more information on how to customize exception rendering.
 */
class ErrorHandler extends BaseErrorHandler
{
    ...
    public function __construct($options = [])
    {
        $defaults = [
            'log' => true,
            'trace' => false,
            'exceptionRenderer' => 'Bit\Error\ExceptionRenderer',
        ];
    ...
    {
        $renderer = Bit::className($this->_options['exceptionRenderer'], 'Error');
        try {
            if (!$renderer) {
     ...
     *
     * @param string|\Bit\Network\Response $response Either the message or response object.
     * @return void
     */
