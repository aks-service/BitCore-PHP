...
use Bit\Cache\Engine\NullEngine;
 ...
 * ```
 * Cache::config('shared', [
 *    'className' => 'Bit\Cache\Engine\ApcEngine',
 *    'prefix' => 'my_app_'
 * ]);
 * ```
 *
...
class Cache
{
    ...
    protected static $_dsnClassMap = [
        'apc' => 'Bit\Cache\Engine\ApcEngine',
        'file' => 'Bit\Cache\Engine\FileEngine',
        'memcached' => 'Bit\Cache\Engine\MemcachedEngine',
        'null' => 'Bit\Cache\Engine\NullEngine',
        'redis' => 'Bit\Cache\Engine\RedisEngine',
        'wincache' => 'Bit\Cache\Engine\WincacheEngine',
        'xcache' => 'Bit\Cache\Engine\XcacheEngine',
    ];
     ...
     *
     * @param \Bit\Core\ObjectRegistry|null $registry Injectable registry object.
     * @return \Bit\Core\ObjectRegistry
     */
     ...
     * @return \Bit\Cache\CacheEngine When caching is disabled a null engine will be returned.
     */
