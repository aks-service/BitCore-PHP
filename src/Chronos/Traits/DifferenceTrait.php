...
use Bit\Chronos\ChronosInterval;
use Bit\Chronos\DifferenceFormatter;
use DatePeriod;
...
trait DifferenceTrait
{
     ...
     *
     * @var \Bit\Chronos\DifferenceFormatter
     */
     ...
     * 5 months after
     *
     * @param \Bit\Chronos\ChronosInterface|null $other The datetime to compare with.
     ...
     *
     * @param \Bit\Chronos\DifferenceFormatter|null $formatter The formatter instance when setting.
     * @return \Bit\Chronos\DifferenceFormatter The formatter instance.
     */
