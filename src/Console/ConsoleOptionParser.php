 ...
 *
 * `bit myshell command --connection default --name=something`
 *
 * Short options can be defined singly or in groups.
 *
 * `bit myshell command -cn`
 *
 ...
 *
 * `bit myshell command -c -n`
 *
 * Short options can also accept values:
 *
 * `bit myshell command -c default`
 *
...
class ConsoleOptionParser
{
     ...
     *
     * @see \Bit\Console\ConsoleOptionParser::description()
     * @var string
     */
     ...
     *
     * @see \Bit\Console\ConsoleOptionParser::epilog()
     * @var string
     */
     ...
     * Option definitions.
     *
     * @see \Bit\Console\ConsoleOptionParser::addOption()
     * @var array
     */
    protected $_options = [];
     ...
     *
     * @param array|\Bit\Console\ConsoleOptionParser $spec ConsoleOptionParser or spec to merge with.
     * @return $this
     */
     ...
     *
     * @param \Bit\Console\ConsoleInputOption|string $name The long name you want to the value to be parsed out as when options are parsed.
     ...
     *   An exception will be raised when parse() encounters an invalid value.
     *
     * @param \Bit\Console\ConsoleInputArgument|string $name The name of the argument.
     ...
     *    it will be used.
     *
     * @param \Bit\Console\ConsoleInputSubcommand|string $name Name of the subcommand. Will also accept an instance of ConsoleInputSubcommand
     ...
     * @throws \Bit\Console\Exception\ConsoleException When an invalid parameter is encountered.
     */
     ...
     * @param array $params The params to append the parsed value into
     * @return array Params with $option added in.
     * @throws \Bit\Console\Exception\ConsoleException When unknown short options are encountered.
     */
