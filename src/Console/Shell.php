...
use Bit\Utility\Traits\MergeVariables;
use Bit\Utility\Text;
 ...
 *
 * Is the equivalent of Bit\Controller\Controller on the command line.
 */
class Shell
{
    use LogTrait;
     ...
     *
     * @param \Bit\Console\ConsoleIo|null $io An io instance.
     */
     ...
     *
     * @param \Bit\Console\ConsoleIo|null $io The ConsoleIo object to use.
     * @return \Bit\Console\ConsoleIo The current ConsoleIo object.
     */
    ...
    public function hasMethod($name)
    {
        try {
            ...
            return $method->getDeclaringClass()->name !== 'Bit\Console\Shell';
     ...
     * @return \Bit\Console\Shell Object of Task
     */
     ...
     * @throws \Bit\Console\Exception\StopException
     * @return void
     */
     ...
     * @return \Bit\Console\Helper The created helper instance.
     */
