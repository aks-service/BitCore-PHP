...
class ConsoleIo
{
     ...
     * The helper registry.
     *
     * @var \Bit\Console\HelperRegistry
     */
    protected $_helpers;
     ...
     * Constructor
     *
     * @param \Bit\Console\ConsoleOutput|null $out A ConsoleOutput object for stdout.
     * @param \Bit\Console\ConsoleOutput|null $err A ConsoleOutput object for stderr.
     * @param \Bit\Console\ConsoleInput|null $in A ConsoleInput object for stdin.
     * @param \Bit\Console\HelperRegistry|null $helpers A HelperRegistry instance
     */
     ...
     * @return void
     * @see \Bit\Console\ConsoleOutput::outputAs()
     */
     ...
     * @see \Bit\Console\ConsoleOutput::styles()
     */
     ...
     * through Bit's Log class, call this function with `$enable=false`.
     *
