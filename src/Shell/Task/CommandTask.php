...
class CommandTask extends Shell
{
    ...
    public function subCommands($commandName)
    {
        ...
        $return = array_map('Bit\Utility\Inflector::underscore', $return);
     ...
     * @return \Bit\Console\Shell|bool Shell instance if the command can be found, false otherwise.
     */
    public function getShell($commandName)
    {
        ...
        $class = Bit::className($pluginDot . $name, 'Shell', 'Shell');
        if (!$class) {
            return false;
        }
