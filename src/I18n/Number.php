...
class Number
{
    ...
    public static function toReadableSize($size)
    {
        switch (true) {
            case $size < 1024:
                return __dn('bit', '{0,number,integer} Byte', '{0,number,integer} Bytes', $size, $size);
            case round($size / 1024) < 1024:
                return __d('bit', '{0,number,#,###.##} KB', $size / 1024);
            case round($size / 1024 / 1024, 2) < 1024:
                return __d('bit', '{0,number,#,###.##} MB', $size / 1024 / 1024);
            case round($size / 1024 / 1024 / 1024, 2) < 1024:
                return __d('bit', '{0,number,#,###.##} GB', $size / 1024 / 1024 / 1024);
            default:
                return __d('bit', '{0,number,#,###.##} TB', $size / 1024 / 1024 / 1024 / 1024);
        }
    }
