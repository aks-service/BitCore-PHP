...
use Bit\Chronos\MutableDateTime;
...
class Time extends MutableDateTime implements JsonSerializable
{
    ...
    /**
     * The format to use when formatting a time using `Bit\I18n\Time::i18nFormat()`
     * and `__toString`
     *
     ...
     * @see \Bit\I18n\Time::i18nFormat()
     */
    protected static $_toStringFormat = [IntlDateFormatter::SHORT, IntlDateFormatter::SHORT];

    /**
     * The format to use when formatting a time using `Bit\I18n\Time::nice()`
     *
     * The format should be either the formatting constants from IntlDateFormatter as
     * described in (http://www.php.net/manual/en/class.intldateformatter.php) or a pattern
     * as specified in (http://www.icu-project.org/apiref/icu4c/classSimpleDateFormat.html#details)
     ...
     *
     * @var string|array|int
     * @see \Bit\I18n\Time::nice()
     */
    public static $niceFormat = [IntlDateFormatter::MEDIUM, IntlDateFormatter::SHORT];

    /**
     * The format to use when formatting a time using `Bit\I18n\Time::timeAgoInWords()`
     * and the difference is more than `Bit\I18n\Time::$wordEnd`
     *
     * @var string
