...
use Bit\Cache\Cache;
use Bit\I18n\Formatter\IcuFormatter;
use Bit\I18n\Formatter\SprintfFormatter;
use Locale;
...
class I18n
{
    ...
    public static function translators()
    {
        ...
        if (class_exists('Bit\Cache\Cache')) {
            static::$_collection->setCacher(Cache::engine('_bit_core_'));
        }
        return static::$_collection;
    }
     ...
     *  echo $translator->translate('Bit');
     * ```
     *
     * You can also use the `Bit\I18n\MessagesFileLoader` class to load a specific
     ...
     *
     * ```
     *  use Bit\I18n\MessagesFileLoader;
