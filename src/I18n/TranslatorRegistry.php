...
class TranslatorRegistry extends TranslatorLocator
{
     ...
     * requests.
     *
     * @param \Bit\Cache\CacheEngine $cacher The cacher instance.
     * @return void
     */
    ...
    protected function _fallbackLoader($name, $locale)
    {
        ...
        // and we want to make sure the bit domain always uses the default formatter
        $formatter = $name === 'bit' ? 'default' : $this->_defaultFormatter;
