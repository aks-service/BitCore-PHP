...
use Bit\Chronos\Date as ChronosDate;
 ...
 *
 * This object provides an immutable variant of Bit\I18n\Date
 */
class FrozenDate extends ChronosDate implements JsonSerializable
{
    ...
    /**
     * The format to use when formatting a time using `Bit\I18n\Date::i18nFormat()`
     * and `__toString`
     *
     ...
     * @see \Bit\I18n\DateFormatTrait::i18nFormat()
     */
    protected static $_toStringFormat = [IntlDateFormatter::SHORT, -1];

    /**
     * The format to use when formatting a time using `Bit\I18n\Date::timeAgoInWords()`
     * and the difference is more than `Bit\I18n\Date::$wordEnd`
     *
     * @var string
     * @see \Bit\I18n\DateFormatTrait::parseDate()
     */
    public static $wordFormat = [IntlDateFormatter::SHORT, -1];

    /**
     * The format to use when formatting a time using `Bit\I18n\Date::nice()`
     *
     * The format should be either the formatting constants from IntlDateFormatter as
     * described in (http://www.php.net/manual/en/class.intldateformatter.php) or a pattern
     * as specified in (http://www.icu-project.org/apiref/icu4c/classSimpleDateFormat.html#details)
     ...
     *
     * @var string|array|int
     * @see \Bit\I18n\DateFormatTrait::nice()
     */
