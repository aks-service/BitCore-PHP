...
use Bit\Log\Engine\BaseLog;
use InvalidArgumentException;

/**
 * Logs messages to configured Log adapters.  One or more adapters
 * can be configured using Bit Logs's methods.  If you don't
 ...
 * classname to use loggers in the `App\Log\Engine` & `Bit\Log\Engine` namespaces.
 ...
 * built-in base class (`Bit\Log\Engine\BaseLog`) that can be used for custom loggers.
 *
 ...
 * ### Logging Levels
 *
 * By default Bit Log supports all the log levels defined in
...
class Log
{
    ...
    protected static $_dsnClassMap = [
        'console' => 'Bit\Log\Engine\ConsoleLog',
        'file' => 'Bit\Log\Engine\FileLog',
        'syslog' => 'Bit\Log\Engine\SyslogLog',
    ];
     ...
     * @return \Bit\Log\Engine\BaseLog|false Instance of BaseLog or false if not found
     */
