...
use Bit\Mailer\Exception\MissingActionException;
 ...
 *
 * @method \Bit\Mailer\Email to($email = null, $name = null)
 * @method \Bit\Mailer\Email from($email = null, $name = null)
 * @method \Bit\Mailer\Email sender($email = null, $name = null)
 * @method \Bit\Mailer\Email replyTo($email = null, $name = null)
 * @method \Bit\Mailer\Email readReceipt($email = null, $name = null)
 * @method \Bit\Mailer\Email returnPath($email = null, $name = null)
 * @method \Bit\Mailer\Email addTo($email, $name = null)
 * @method \Bit\Mailer\Email cc($email = null, $name = null)
 * @method \Bit\Mailer\Email addCc($email, $name = null)
 * @method \Bit\Mailer\Email bcc($email = null, $name = null)
 * @method \Bit\Mailer\Email addBcc($email, $name = null)
 * @method \Bit\Mailer\Email charset($charset = null)
 * @method \Bit\Mailer\Email headerCharset($charset = null)
 * @method \Bit\Mailer\Email subject($subject = null)
 * @method \Bit\Mailer\Email setHeaders(array $headers)
 * @method \Bit\Mailer\Email addHeaders(array $headers)
 * @method \Bit\Mailer\Email getHeaders(array $include = [])
 * @method \Bit\Mailer\Email template($template = false, $layout = false)
 * @method \Bit\Mailer\Email viewRender($viewClass = null)
 * @method \Bit\Mailer\Email viewVars($viewVars = null)
 * @method \Bit\Mailer\Email theme($theme = null)
 * @method \Bit\Mailer\Email helpers($helpers = null)
 * @method \Bit\Mailer\Email emailFormat($format = null)
 * @method \Bit\Mailer\Email transport($name = null)
 * @method \Bit\Mailer\Email messageId($message = null)
 * @method \Bit\Mailer\Email domain($domain = null)
 * @method \Bit\Mailer\Email attachments($attachments = null)
 * @method \Bit\Mailer\Email addAttachments($attachments)
 * @method \Bit\Mailer\Email message($type = null)
 * @method \Bit\Mailer\Email profile($config = null)
 */
abstract class Mailer implements EventListenerInterface
{
     ...
     * @return array
     * @throws \Bit\Mailer\Exception\MissingActionException
