...
class EventManager
{
    ...
    /**
     * Returns the globally available instance of a Bit\Event\EventManager
     ...
     *
     * @param \Bit\Event\EventManager|null $manager Event manager instance.
     * @return \Bit\Event\EventManager the global event manager
     */
     ...
     *
     * @param callable|\Bit\Event\EventListenerInterface $callable PHP valid callback type or instance of Bit\Event\EventListenerInterface to be called
     * when the event named with $eventKey is triggered. If a Bit\Event\EventListenerInterface instance is passed, then the `implementedEvents`
     ...
     * is an instance of Bit\Event\EventListenerInterface this argument will be ignored
     *
     ...
     *   instance of Bit\Event\EventListenerInterface.
     ...
     * ```
     *
     * @param string|\Bit\Event\EventListenerInterface|null $eventKey The event unique identifier name
     * with which the callback will be associated. If $eventKey is an instance of
     * Bit\Event\EventListenerInterface its events will be bound using the `implementedEvents` methods.
     *
    ...
    /**
     * Auxiliary function to attach all implemented callbacks of a Bit\Event\EventListenerInterface class instance
     * as individual methods on this manager
     *
     * @param \Bit\Event\EventListenerInterface $subscriber Event listener.
     * @return void
     */
     ...
     * from the return value of the `implementedEvents` method on a Bit\Event\EventListenerInterface
     *
     * @param array $function the array taken from a handler definition for an event
     * @param \Bit\Event\EventListenerInterface $object The handler object
     * @return callable
     */
     ...
     *
     * @param callable|\Bit\Event\EventListenerInterface $callable any valid PHP callback type or an instance of EventListenerInterface
     ...
     * ```
     *
     * @param string|\Bit\Event\EventListenerInterface $eventKey The event unique identifier name
     ...
     *
     * @param \Bit\Event\EventListenerInterface $subscriber the subscriber to be detached
     ...
     *
     * @param string|\Bit\Event\Event $event the event key name or instance of Event
