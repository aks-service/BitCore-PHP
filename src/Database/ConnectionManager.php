...
use Bit\Database\Exception\MissingDatasourceConfigException;
...
class ConnectionManager
{
    ...
    protected static $_dsnClassMap = [
        'mysql' => 'Bit\Database\Driver\Mysql',
        'postgres' => 'Bit\Database\Driver\Postgres',
        'sqlite' => 'Bit\Database\Driver\Sqlite',
        'sqlserver' => 'Bit\Database\Driver\Sqlserver',
    ];

    /**
     * The ConnectionRegistry used by the manager.
     *
     * @var \Bit\Datasource\ConnectionRegistry
     */
     ...
     * @throws \Bit\Core\Exception\Exception When trying to modify an existing config.
     * @see \Bit\Core\Traits\StaticConfig::config()
     */
     ...
     *
     * $dsn = 'Bit\Database\Driver\Mysql://localhost:3306/database?className=Bit\Database\Connection';
     * $config = ConnectionManager::parseDsn($dsn);
     *
     * $dsn = 'Bit\Database\Connection://localhost:3306/database?driver=Bit\Database\Driver\Mysql';
     * $config = ConnectionManager::parseDsn($dsn);
     * ```
     *
    ...
    public static function parseDsn($config = null)
    {
        ...
        if (empty($config['driver'])) {
            ...
            $config['className'] = 'Bit\Database\Connection';
        }
     ...
     * @return void
     * @throws \Bit\Database\Exception\MissingDatasourceConfigException When aliasing a
     ...
     * @return \Bit\Database\ConnectionInterface|\Bit\Database\Connection A connection object.
     * @throws \Bit\Database\Exception\MissingDatasourceConfigException When config
     * data is missing.
     */
