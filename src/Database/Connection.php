...
use Bit\Core\Bit;
use Bit\Database\Exception\MissingConnectionException;
use Bit\Database\Exception\MissingDriverException;
use Bit\Database\Exception\MissingExtensionException;
use Bit\Database\Log\LoggedQuery;
use Bit\Database\Log\LoggingStatement;
use Bit\Database\Log\QueryLogger;
use Bit\Database\Schema\CachedCollection;
use Bit\Database\Schema\Collection as SchemaCollection;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Bit\Database\Log\QueryLogger
     */
     ...
     *
     * @var \Bit\Database\Schema\Collection
     */
     ...
     *
     * @param \Bit\Database\Driver|string|null $driver The driver instance to use.
     * @param array $config Either config for a new driver or null.
     * @throws \Bit\Database\Exception\MissingDriverException When a driver class is missing.
     * @throws \Bit\Database\Exception\MissingExtensionException When a driver's PHP extension is missing.
     * @return \Bit\Database\Driver
     */
    public function driver($driver = null, $config = [])
    {
        ...
        if (is_string($driver)) {
            $className = Bit::className($driver, 'Database/Driver');
     ...
     *
     * @throws \Bit\Database\Exception\MissingConnectionException if credentials are invalid
     ...
     *
     * @param string|\Bit\Database\Query $sql The SQL to convert into a prepared statement.
     ...
     * @return \Bit\Database\StatementInterface executed statement
     */
     ...
     *
     * @param \Bit\Database\Schema\Collection|null $collection The schema collection object
     * @return \Bit\Database\Schema\Collection
     */
     ...
     *   true to use `_bit_model_` or the name of the cache config to use.
     * @return void
     */
     ...
     *
     * @param \Bit\Database\StatementInterface $statement the instance to be decorated
     * @return \Bit\Database\Log\LoggingStatement
     */
