...
use Bit\Database\StatementInterface;
use Bit\Database\TypeConverterTrait;
use Countable;
...
class StatementDecorator implements StatementInterface, Countable, IteratorAggregate
{
     ...
     * Constructor
     *
     * @param \Bit\Database\StatementInterface|null $statement Statement implementation such as PDOStatement
