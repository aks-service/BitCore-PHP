...
class Table
{
     ...
     *   one of BitPHP's abstract types.
     ...
     * @return array
     * @throws \Bit\Database\Exception When foreign key definition is not valid.
     */
     ...
     *
     * @param \Bit\Datasource\ConnectionInterface $connection The connection to generate SQL for
