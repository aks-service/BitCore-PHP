...
abstract class BaseSchema
{
     ...
     *
     * @param \Bit\Database\Driver $driver The driver to use.
     */
     ...
     *
     * @param \Bit\Database\Schema\Table $table Table instance
     ...
     *
     * @param \Bit\Database\Schema\Table $table The table object to append fields to.
     ...
     *
     * @param \Bit\Database\Schema\Table $table The table object to append
     ...
     *
     * @param \Bit\Database\Schema\Table $table The table instance the column is in.
     ...
     *
     * @param \Bit\Database\Schema\Table $table The table instance the foreign key constraints are.
     ...
     *
     * @param \Bit\Database\Schema\Table $table The table object the column is in.
     * @param string $name The name of the column.
     * @return string SQL fragment.
     */
